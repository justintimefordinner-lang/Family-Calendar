...
(() => {
  ...
  const settings = {
    family_name: (q.get('family') || '').trim().slice(0, 40) || 'Scooby Doo Calendar', // ?family=… shows any name on the example site without storing it timezone: Intl.DateTimeFormat().resolvedOptions().timeZone, week_start: 0,
